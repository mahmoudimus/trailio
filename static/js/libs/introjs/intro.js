...
(function (root, factory) {
  ...
  function _introForElement(targetElm) {
    ...
    if(_addOverlayLayer.call(self, targetElm)) {
      ...
      var skipButton = targetElm.querySelector('.btn-mini'),
          nextStepButton = targetElm.querySelector('.btn-mini');
  ...
  function _placeTooltip(targetElement, tooltipLayer, arrowLayer) {
    ...
    switch (currentTooltipPosition) {
      case 'top':
        ...
        break;
      case 'right':
          tooltipLayer.style.right = '-175%';
        arrowLayer.className = 'introjs-arrow left';
        break;
      case 'left':
        tooltipLayer.style.left = '-175%';
...
//                               '</div><div class="introjs-tooltipbuttons"></div>';
      ...
      nextTooltipButton.className = 'btn btn-mini';
//      nextTooltipButton.className = 'introjs-button introjs-nextbutton';
      ...
      prevTooltipButton.className = 'btn btn-mini';
//      prevTooltipButton.className = 'introjs-button introjs-prevbutton';
      ...
      skipTooltipButton.className = 'btn btn-mini';
//      skipTooltipButton.className = 'introjs-button introjs-skipbutton';
      ...
      var tooltipButtonsLayer = tooltipLayer.querySelector('.btn-group');

...
(function (root, factory) {
  ...
  function _showElement(targetElement) {
    ...
    if(oldHelperLayer != null) {
      ...
      skipTooltipButton.className = 'btn btn-default btn-sm introjs-skipbutton';
    ...
    if (this._currentStep == 0) {
      prevTooltipButton.className = 'btn btn-default btn-sm introjs-prevbutton introjs-disabled';
      nextTooltipButton.className = 'btn btn-default btn-sm introjs-nextbutton';
      skipTooltipButton.innerHTML = this._options.skipLabel;
    } else if (this._introItems.length - 1 == this._currentStep) {
      skipTooltipButton.innerHTML = this._options.doneLabel;
      prevTooltipButton.className = 'btn btn-default btn-sm introjs-prevbutton';
      nextTooltipButton.className = 'btn btn-default btn-sm introjs-nextbutton introjs-disabled';
    } else {
      prevTooltipButton.className = 'btn btn-default btn-sm introjs-prevbutton';
      nextTooltipButton.className = 'btn btn-default btn-sm introjs-nextbutton';
      skipTooltipButton.innerHTML = this._options.skipLabel;
